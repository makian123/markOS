...
nasm -f elf64 asm/shutdown.asm -o builds/shutdown.o
...
ld -n -o kernel.bin -T linker.ld builds/multiboot_header.o builds/boot.o builds/long_mode_init.o builds/crti.o builds/crtn.o builds/shutdown.o builds/kernel.o builds/terminal.o builds/osMath.o builds/conversion.o builds/char.o builds/malloc.o builds/string.o
